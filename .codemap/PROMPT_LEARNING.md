  ...
  function:
    ...
    131-138: getLatestVersion(db: Database.Database): any [exported]
      ...
      refs in: 5 [call: 3, import: 2]
        ...
        - src/daemon/scheduler.ts:474: call Scheduler.latestVersion
...
---
Files: 14
Estimated tokens: 10,775 (codebase: ~1,047,195)
